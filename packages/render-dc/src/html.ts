...
<body>
  <div class="container">
    ...
    <div class="badge">dc.js · static · crossfilter · <span class="reset" id="reset-all">reset filters</span></div>
    <div class="charts">
    ${slots}
    </div>
    <footer>Built with dvfc · <a href="https://dc-js.github.io/dc.js/">dc.js</a> · static (CDN + inlined CSV)</footer>
  </div>
