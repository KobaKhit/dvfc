  ...
  <style>
    ...
    * {
    ...
    .chart-container {
      ...
      overflow: hidden;
      margin: 0;
      padding: ${spec.theme?.chartBorders === false ? '0' : '1rem 1rem 0.75rem'};
      border: ${spec.theme?.chartBorders === false ? '0' : '1px solid var(--line)'};
      border-radius: ${spec.theme?.chartBorders === false ? '0' : '4px'};
      background: ${spec.theme?.chartBorders === false ? 'transparent' : '#fff'};
      box-shadow: none;
    }
    ...
    body.is-embedded .chart-container {
      padding: ${spec.theme?.chartBorders === false ? '0' : '0.65rem'};
    }
