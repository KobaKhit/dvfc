 ...
 */
export declare class RasterMark extends Grid2DMark {
    image: any;
 ...
 */
export declare class HeatmapMark extends RasterMark {
    constructor(source: any, options: any);
}
/**
 ...
 */
export declare function rasterEncoding(mark: RasterMark): {
    alphaProp: any;
    colorProp: any;
 ...
 */
export declare function imageData(mark: RasterMark, w: number, h: number): any;
