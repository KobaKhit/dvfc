 ...
 */
export declare function intersect(svg: SVGSVGElement, el: SVGElement, extent: [[number, number], [number, number]]): Element[];
export declare function intersectPath(l: any, t: any, r: any, b: any, el: any): boolean;
