 ...
 */
export declare function array(size: number, proto?: Arrayish): Arrayish;
/**
 ...
 */
export declare function grid1d(size: number, index: Arrayish, value: Arrayish, columns: Record<string, Arrayish>, groupby: string[]): {
    numRows: number;
    columns: {
        [key: string]: Arrayish;
    };
 ...
 * }} Named column arrays of generated grid values.
 */
export declare function grid2d(w: number, h: number, index: Arrayish, columns: Record<string, Arrayish>, aggregates: string[], groupby: string[], interpolate?: Function): {
    numRows: number;
    columns: {
        [key: string]: Arrayish;
    };
};
export declare function gridDomainContinuous(grids: any): number[];
export declare function gridDomainDiscrete(grids: any): any[];
