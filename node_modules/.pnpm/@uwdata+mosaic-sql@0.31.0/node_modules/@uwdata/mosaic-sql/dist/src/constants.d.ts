...
export declare const PIVOT_QUERY = "PIVOT_QUERY";
export declare const DESCRIBE_QUERY = "DESCRIBE_QUERY";
export declare const SET_OPERATION = "SET_OPERATION";
export declare const CREATE_QUERY = "CREATE_QUERY";
export declare const CREATE_SCHEMA_QUERY = "CREATE_SCHEMA_QUERY";
