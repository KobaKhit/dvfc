import { PivotQuery } from './pivot.js';
 ...
 * @param value The value to check.
 */
export function isCreateQuery(value) {
 ...
 * @param value The value to check.
 */
export function isCreateSchemaQuery(value) {
...
export class CreateQuery extends SQLNode {
     ...
     */
    constructor(name, query, { replace = false, temp = false, view = false } = {}) {
        super(CREATE_QUERY);
