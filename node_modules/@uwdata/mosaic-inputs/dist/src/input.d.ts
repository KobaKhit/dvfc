 ...
 */
export declare function input<T extends new (...args: any) => Input>(InputClass: T, ...params: ConstructorParameters<T>): HTMLElement;
 ...
 */
export declare class Input extends MosaicClient implements Activatable {
    element: HTMLElement;
    /**
