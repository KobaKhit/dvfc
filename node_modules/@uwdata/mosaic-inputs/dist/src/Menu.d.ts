 ...
 */
export declare const menu: (options?: {
    element?: HTMLElement;
    filterBy?: Selection;
    as?: Param<any>;
    field?: string;
 ...
 * @extends {Input}
 */
export declare class Menu extends Input {
    from: string;
    column: string;
    format: (value: any) => string;
    field: string;
     ...
     * @param {'any' | 'all'} [options.listMatch] The list match mode.
     */
    constructor({ element, filterBy, as, from, column, label, format, // TODO
    options, value, field, listMatch, }?: {
        element?: HTMLElement;
        filterBy?: Selection;
        as?: Param<any>;
        field?: string;
