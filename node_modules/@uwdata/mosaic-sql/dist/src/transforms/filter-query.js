 ...
 */
export function filterPushdown(query, table, filter) {
    ...
    const cte = new WithClauseNode(filteredName, Query.select("*").from(tableRef).where(filter));
 ...
 */
export function filterQuery(query, table) {
    return (filter) => filterPushdown(query, table, filter);
}
