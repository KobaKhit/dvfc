 ...
 * @param value The value to check.
 */
export declare function isCreateQuery(value: unknown): value is CreateQuery;
/**
 * Check if a value is a create schema query.
 * @param value The value to check.
 */
export declare function isCreateSchemaQuery(value: unknown): value is CreateSchemaQuery;
export declare class Query extends ExprNode {
     ...
     */
    static pivot(source: PivotSource): PivotQuery;
    /**
...
export declare class CreateQuery extends SQLNode {
     ...
     */
    constructor(name: string | TableRefNode, query: string | Query, { replace, temp, view }?: CreateTableOptions);
}
export interface CreateSchemaOptions {
    strict?: boolean;
}
export declare class CreateSchemaQuery extends SQLNode {
    /** The schema name. */
    readonly name: TableRefNode;
     ...
     */
    constructor(name: string | TableRefNode, { strict }?: CreateSchemaOptions);
}
...
declare class WithClause {
     ...
     * @param source The source relation to pivot.
     */
    pivot(source: PivotSource): PivotQuery;
    /**
     * Create a new UNION set operation over the given queries.
     * @param queries The queries.
     */
