import { ColumnRefNode, isNode, isQuery, isTableRef } from '../../ast/index.js';
...
export class DuckDBCodeGenerator extends SQLCodeGenerator {
    ...
    visitSelectQuery(node) {
        const { _select, _distinct, _from, _sample, _where, _groupby, _having, _window, _qualify } = node;
        const sql = [];
        // SELECT
